    ...
    const checkAuth = async () => {
      if (token) {
        try {
          ...
          const apiUrl = import.meta.env.VITE_BIPCF_API_URL || (isLocalhost ? 'http://localhost:5000/api/handshake/verify-handshake' : 'https://bipcf.org/api/handshake/verify-handshake');
